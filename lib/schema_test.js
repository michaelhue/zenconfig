...
tap.test('string type conversion', t => {
  let actual, expected
...
tap.test('number type conversion', t => {
  let actual, expected
...
tap.test('boolean type conversion', t => {
...
tap.test('array type conversion', t => {
  let actual, expected
...
tap.test('invalid type conversion', t  => {
